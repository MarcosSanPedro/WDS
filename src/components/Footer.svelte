<script lang="ts">
  import { Phone, Mail, MapPin, Facebook, Instagram, Linkedin } from 'lucide-svelte';
  import * as m from '$lib/paraglide/messages';
</script>

<footer class="bg-[#1A365D] text-white pt-16 pb-8">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
      <!-- Company Info -->
      <div>
        <h3 class="text-2xl font-bold mb-4">{m['company.short_name']()}</h3>
      ...
      <div>
        ...
        <ul class="space-y-2 text-white/80">
          ...
          <li><a href="/services/bathroom-remodeling" class="hover:text-[#F6AD55] transition-colors duration-200">{m['footer.bathroom_remodeling']()}</a></li>
          <li><a href="/services/whole-home-renovations" class="hover:text-[#F6AD55] transition-colors duration-200">{m['footer.whole_home_renovations']()}</a></li>
          <li><a href="/services/commercial-construction" class="hover:text-[#F6AD55] transition-colors duration-200">{m['footer.commercial_construction']()}</a></li>
