...
export const _services: Record<string, Services>  = {
  ...
  trends: [
    {
      ...
      description:
        'Spaces designed for both in‑office collaboration and remote meeting needs.',
      icon: Users
    },
    {
  ...
  faqs: [
    { question: 'Can work happen during business hours?', answer: 'Yes. We phase work and can schedule after‑hours to reduce disruption.' },
    { question: 'Do you source furniture?', answer: 'We can specify, procure, and install ergonomic furniture to match the design.' },
    { question: 'Do you handle permits?', answer: 'Yes, including MEP drawings, life‑safety coordination, and inspections.' },
    { question: 'Can you support hybrid offices?', answer: 'Absolutely — focus rooms, huddle areas, and video‑ready conference spaces.' },
    { question: 'What about IT and AV?', answer: 'We coordinate with your vendors or provide turnkey solutions.' }
  ],
  cta: {
...
'retail-construction': {
  ...
  faqs: [
    { question: 'Can you meet a strict launch date?', answer: 'Yes. We plan backwards from your launch and compress schedules with phased trades when needed.' },
    { question: 'Do you fabricate custom millwork?', answer: 'We design and build custom fixtures or work with your preferred vendors.' },
    { question: 'Do you coordinate signage and permits?', answer: 'Yes, including exterior signage and municipal approvals.' },
    { question: 'Can stores remain open during renovations?', answer: 'We can phase and barricade construction to keep trading where feasible.' },
    { question: 'Do you roll out multi‑location builds?', answer: 'We standardize details to scale across your portfolio.' }
  ],
  cta: {
...
'industrial-upgrades': {
  ...
  faqs: [
    { question: 'Can you work during live operations?', answer: 'Yes. We coordinate with production to schedule shutdowns and safe work windows.' },
    { question: 'Do you provide stamped engineering?', answer: 'We deliver PE‑stamped drawings as required by jurisdiction.' },
    { question: 'Can you install owner‑furnished equipment?', answer: 'Absolutely. We set, anchor, and align to manufacturer specs.' },
    { question: 'Do you update as‑builts?', answer: 'Yes, including redlines and digital O&M documentation.' },
    { question: 'What about safety compliance?', answer: 'Our programs meet OSHA requirements and your site‑specific policies.' }
  ],
  cta: {
...
'commercial-maintenance': {
  ...
  faqs: [
    { question: 'Do you offer 24/7 support?', answer: 'Yes. Emergency response is available based on SLA.' },
    { question: 'Can you manage multiple properties?', answer: 'We centralize reporting and billing across your portfolio.' },
    { question: 'Do you handle compliance items?', answer: 'We coordinate routine checks and keep documentation updated.' },
    { question: 'How do tenants submit tickets?', answer: 'We provide a simple portal/email workflow tracked to SLAs.' },
    { question: 'Is pricing flexible?', answer: 'Yes — per‑call, retainer, or fixed PM programs.' }
  ],
  cta: {
...
'restaurant-hospitality-renovations': {
  ...
  faqs: [
    { question: 'Do you work with health department requirements?', answer: 'Yes — we coordinate submittals, inspections, and corrections.' },
    { question: 'Can we keep partial service during a remodel?', answer: 'Often yes with phased areas and temporary kitchens.' },
    { question: 'Do you install kitchen equipment?', answer: 'We coordinate trades and final connections to spec.' },
    { question: 'Can you improve acoustics?', answer: 'We design materials and layouts to reduce reverberation times.' },
    { question: 'What about ADA?', answer: 'We ensure restrooms, seating, and circulation meet accessibility standards.' }
  ],
  cta: {
...
'commercial-building-additions': {
  ...
  faqs: [
    { question: 'Can you match our existing façade?', answer: 'Yes. We source compatible systems or propose tasteful updates across both volumes.' },
    { question: 'Do you handle utilities expansion?', answer: 'We coordinate with utility providers and resize systems as needed.' },
    { question: 'How do you minimize disruption?', answer: 'Clear logistics plans, temporary partitions, and off‑hour work where needed.' },
    { question: 'What about future expansion?', answer: 'We can design structural and service stubs to enable later growth.' },
    { question: 'Do you provide cost phasing?', answer: 'Yes — options for shell‑only vs. full build‑out.' }
  ],
  cta: {
...
'sustainable-commercial-construction': {
  ...
  faqs: [
    { question: 'Will this actually lower bills?', answer: 'Yes — we target measures with clear payback and share modeled savings ranges.' },
    { question: 'Do you help with rebates?', answer: 'We identify and process incentives to reduce upfront costs.' },
    { question: 'Can we phase improvements?', answer: 'Absolutely. We build multi‑year roadmaps aligned to capital cycles.' },
    { question: 'Does this affect comfort?', answer: 'Expect better temperatures, air quality, and acoustics.' },
    { question: 'Is LEED or similar required?', answer: 'Certification is optional — we can design to standards with or without formal pursuit.' }
  ],
  cta: {
